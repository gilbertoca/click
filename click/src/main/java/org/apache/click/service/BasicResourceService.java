...
/**
 * Provides a lightweight HTTP resource service that serves static resources
 * (JS, CSS, images) directly from the Classpath (META-INF/resources).
 * <p/>
 * This service is compliant with Servlet 3.0+ specifications and does not
 * perform any physical deployment of files to the web application directory.
 * It is the ideal choice for modern, restricted, or immutable environments
 * like Docker containers or Cloud PaaS (e.g., Google App Engine).
 *
 * @since 2.5.0
 */
